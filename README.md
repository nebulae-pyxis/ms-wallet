...
![Intro](docs/images/ms-wallet_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [wallet](#backend_wallet)
        * [Environment variables](#backend_wallet_env_vars)
        * [Event Sourcing](#backend_wallet_eventsourcing)
        * [CronJobs](#backend_wallet_cronjobs)
...
│   ├── wallet                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/wallet/schema.gql)
...
## wallet <a name="backend_wallet"></a>
...


### Environment variables <a name="backend_wallet_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/wallet/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-wallet.yaml)

### Event Sourcing <a name="backend_wallet_eventsourcing"></a>
...
### CronJobs <a name="backend_wallet_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-pyxis/ms-wallet.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-pyxis/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-wallet/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-wallet/etc/mfe-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-wallet/backend/wallet/.env   *WORKING_FOLDER*/ms-wallet/playground/emi-gateway/.env  
