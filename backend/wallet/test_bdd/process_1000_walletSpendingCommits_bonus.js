...
describe("E2E - Simple transaction", function() {
  ...
  */
  ...
  /**
   * Create spending rule and insert an product bonus config
   */
  describe("Create SpendingRule", function() {
    ...
    // INSERT PRODUCTBONUSCONFIT AT THE SPENDINGRULE
    ...
    it("Push money at the business wallet in bonus pocket", function(done){
  ...
  describe("process 100 walletSpending commits", function() {
    ...
    it("Process the 100 events", function(done) {
      ...
      of({})
        ...
        .subscribe(
          () => console.log( "##### WALLET SPENDING COMMITS SENT"),
          error => {
            console.log(error);
            return done(error);
          },
